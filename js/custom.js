...
const project1 = new Project("Website projects","Websites");
const project2 = new Project("Game projects","Games");
const project3 = new Project("Art projects","Art Gallery");
...
const school1 = new School ("ÉTS",user.country,"Software enginnering program (Bachelor's degree)","2020 - Present");
